...
export default function Page() {
  const [state, setState] = useState<MegaMenuState>(DEFAULT_MEGAMENU_STATE);
  ...
  return <AppShell contentOverflow="hidden"><PlaygroundLayout title="Mega Menu Studio" controls={controls} preview={output} /></AppShell>;
}
